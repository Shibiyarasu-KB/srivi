...
export default function AboutUs() {
  ...
  return (
    <div className="w-full min-h-screen bg-center  bg-[url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEmMlpF3jYuq10HYfCMMxzaotGN8333Cn19A&s')] bg-cover bg-fixed text-justify">
